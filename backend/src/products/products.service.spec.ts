  ...
  describe('findAll', () => {
      ...
      const mockProducts = [
        {
          ...
          designer: null,
          pricing: { listPrice: 145, salePrice: null, priceInclVat: 152.25 },
          dimensions: null,
          packaging: null,
    ...
    it('should handle pagination correctly', async () => {
      ...
      const mockProducts = Array.from({ length: 10 }, (_, i) => ({
        ...
        designer: null,
        pricing: { listPrice: 100, salePrice: null, priceInclVat: 105 },
        dimensions: null,
        packaging: null,
        images: [],
        specifications: [],
  ...
  describe('findOne', () => {
    ...
    it('should include full details in response', async () => {
      const mockProduct = {
        ...
        pricing: { listPrice: 145, salePrice: null, priceInclVat: 152.25 },
        dimensions: {
          functionalDepthCm: 11,
          functionalWidthCm: 1,
          functionalHeightCm: 1,
