...
class _AdminReportsScreenState extends State<AdminReportsScreen>
  ...
  Widget _buildBody() {
    ...
    final categories =
        (_data!['categoryPerformance'] as List?)
            ...
            child: InkWell(
              ...
              child: AnimatedContainer(
                ...
                decoration: BoxDecoration(
                  ...
                  borderRadius: BorderRadius.circular(8),
                  border: Border.all(color: sel ? _accent : Colors.grey[300]!),
                  boxShadow: sel
                      ? [
                          BoxShadow(
  ...
  // SECTION HEADER
  // ═══════════════════════════════════════════════════════════
  Widget _sec(IconData icon, String title, {String? subtitle}) => Row(
    children: [
      Container(
  ...
  Widget _financialKPIs(Map<String, dynamic> fin) {
    ...
    final tiles = [
      ...
      _KpiData(
        'Total Orders',
        _nFmt.format(_i(fin['totalOrders'])),
        Icons.shopping_bag_outlined,
        _cyan,
        {
      ...
      _KpiData(
        'Total Discounts',
        _cFmt.format(_d(at['discount'])),
        Icons.discount_outlined,
        _pink,
        {'discount': _d(at['discount'])},
      ),
    ];
    return Wrap(
      spacing: 14,
                  ...
                  LineChartBarData(
                    ...
                    dotData: FlDotData(
                      ...
                      getDotPainter: (spot, _, __, ___) {
                        final isSelected = spot.x.toInt() == _selectedRevDay;
                    ...
                    belowBarData: BarAreaData(
                      ...
                      gradient: LinearGradient(
                        ...
                        colors: [_accent.withAlpha(46), _accent.withAlpha(3)],
                      ),
                    ),
                  ),
                ],
        ...
        content: SizedBox(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 4),
              Text(
                '${pct.toStringAsFixed(1)}% of total orders',
  ...
  Widget _topProductsSection(List<Map<String, dynamic>> products) {
    ...
    final maxRev = products.fold<double>(
      0,
      (m, p) => _d(p['totalRevenue']) > m ? _d(p['totalRevenue']) : m,
    );
                            ...
                            child: Text(
                              ...
                              style: TextStyle(
                                ...
                                color: idx == _barTouchedProduct
                                    ? _accent
                                    : Colors.grey[600],
                                fontWeight: idx == _barTouchedProduct
                                    ? FontWeight.w700
                                    : FontWeight.w400,
                              ),
      ...
      child: Padding(
        ...
        child: Row(
          children: [
            ...
            _statChip('Revenue', _cFmt.format(_d(p['totalRevenue'])), _accent),
            const SizedBox(width: 10),
        ...
        content: SizedBox(
          ...
          child: Column(
            ...
            children: [
              ...
              _detailRow('Total Revenue', _cFmt.format(_d(p['totalRevenue']))),
              _detailRow('Total Quantity Sold', '${p['totalQty']}'),
              _detailRow('Total Orders', '${p['totalOrders']}'),
              _detailRow(
                'Avg Revenue/Order',
                _i(p['totalOrders']) > 0
                    ? _cFmt.format(_d(p['totalRevenue']) / _i(p['totalOrders']))
                    : 'N/A',
              ),
              _detailRow(
                'Avg Qty/Order',
                          ...
                          touchCallback: (event, response) {
                            if (event is FlTapUpEvent) {
                              final idx =
                                  ...
                                  -1;
                              setState(
                                () => _pieTouchedStock = _pieTouchedStock == idx
                                    ? -1
                                    : idx,
                              );
                            }
                  ...
                  child: Wrap(
                    ...
                    children: List.generate(dist.length, (i) {
                      ...
                      return MouseRegion(
                        ...
                        child: GestureDetector(
                          onTap: () => setState(
                            () => _pieTouchedStock = _pieTouchedStock == i
                                ? -1
                                : i,
                          ),
                          child: AnimatedContainer(
                            ...
                            decoration: BoxDecoration(
                              color: isSel
                                  ? _stockColors[i % _stockColors.length]
                                        .withAlpha(30)
                                  : Colors.transparent,
                              borderRadius: BorderRadius.circular(6),
                              border: isSel
                ...
                Padding(
                  ...
                  child: Row(
                    children: [
                      ...
                      Text(
                        'Low Stock Items (${allLowItems.length})',
                        style: const TextStyle(
                          fontWeight: FontWeight.w600,
                          fontSize: 13,
                          color: Color(0xFF334155),
        ...
        content: SizedBox(
          ...
          child: Column(
            ...
            children: [
              ...
              _detailRow('Current Stock', '${_i(item['stockQty'])} units'),
              _detailRow(
                'Status',
                _i(item['stockQty']) == 0 ? 'OUT OF STOCK' : 'LOW STOCK',
              ),
              _detailRow(
                'Product Active',
        ...
        content: SizedBox(
          ...
          child: Column(
            ...
            children: [
              ...
              _detailRow('Total Spent', _cFmt.format(_d(c['totalSpent']))),
              _detailRow('Total Orders', '${c['orderCount']}'),
              _detailRow(
                'Avg Order Value',
                _i(c['orderCount']) > 0
                    ? _cFmt.format(_d(c['totalSpent']) / _i(c['orderCount']))
                    : 'N/A',
              ),
            ],
          ),
                      ...
                      SingleChildScrollView(
                        ...
                        child: DataTable(
                          ...
                          columns: const [
                            ...
                            DataColumn(label: Text('Eff. Rate'), numeric: true),
                          ],
                          rows: monthly.map((m) {
                            final rev = _d(m['totalRevenue']);
                            final vatAmt = _d(m['vatCollected']);
                            final rate = rev > 0 ? (vatAmt / rev * 100) : 0.0;
                            return DataRow(
                              onSelectChanged: (_) => _showVatMonthDetail(m),
                              cells: [
                                DataCell(Text(m['month']?.toString() ?? '')),
                                DataCell(
                                  Text(_nFmt.format(_i(m['orderCount']))),
                                ),
        ...
        content: SizedBox(
          ...
          child: Column(
            ...
            children: [
              ...
              _detailRow('Total Orders', _nFmt.format(_i(m['orderCount']))),
              _detailRow('Total Revenue', _cFmt.format(rev)),
              _detailRow('VAT Collected', _cFmt.format(vatAmt)),
              _detailRow(
                'Effective Rate',
                rev > 0 ? '${(vatAmt / rev * 100).toStringAsFixed(2)}%' : 'N/A',
              ),
              _detailRow(
                'Avg VAT/Order',
                _i(m['orderCount']) > 0
  ...
  Widget _categorySection(List<Map<String, dynamic>> categories) {
    ...
    final maxRev = sorted.fold<double>(
      0,
      (m, c) => _d(c['revenue']) > m ? _d(c['revenue']) : m,
    );
                        ...
                        child: Row(
                          ...
                          children: [
                            Text(
                              ...
                              style: TextStyle(
                                fontSize: 11,
                                color: isSel ? _accent : Colors.grey[600],
                                fontWeight: isSel
                                    ? FontWeight.w600
                                    : FontWeight.w400,
                              ),
          ...
          child: Column(
            ...
            children: [
              ...
              _detailRow(
                'Avg Qty/Order',
                _i(c['orders']) > 0
                    ? (_i(c['qty']) / _i(c['orders'])).toStringAsFixed(1)
                    : 'N/A',
              ),
            ],
          ),
  ...
  Widget _promoSection(List<Map<String, dynamic>> promos) {
    ...
    final filtered = _promoSearch.isEmpty
        ...
        : promos
              .where(
                (p) => (p['code']?.toString().toLowerCase() ?? '').contains(
                  _promoSearch.toLowerCase(),
                ),
              )
              .toList();
                  ...
                  rows: sorted.map((p) {
                    ...
                    return DataRow(
                      ...
                      cells: [
                        ...
                        DataCell(
                          Text(_fmtLabel(p['discountType']?.toString() ?? '')),
                        ),
                        DataCell(
                          Text(
                        ...
                        DataCell(Text(_cFmt.format(_d(p['totalRevenue'])))),
                        DataCell(Text(_cFmt.format(_d(p['totalDiscount'])))),
                        DataCell(
                          Container(
                            padding: const EdgeInsets.symmetric(
                              horizontal: 8,
                            ...
                            decoration: BoxDecoration(
                              color: (isActive ? _success : _danger).withAlpha(
                                20,
                              ),
                              borderRadius: BorderRadius.circular(6),
                            ),
          ...
          child: Column(
            ...
            children: [
              ...
              if (_i(p['orderCount']) > 0)
                _detailRow(
                  'Avg Revenue/Order',
                  _cFmt.format(_d(p['totalRevenue']) / _i(p['orderCount'])),
                ),
            ],
          ),
        ),
  ...
  Widget _emptyCard(String msg) => _card(
    height: 160,
    child: Center(
      child: Text(msg, style: TextStyle(color: Colors.grey[400], fontSize: 13)),
    ),
  );
