...
class _AdminReportsScreenState extends State<AdminReportsScreen>
  ...
  Widget _topProductsChart(List<Map<String, dynamic>> products) {
    ...
    final maxRev = products.fold<double>(
      0,
      (m, p) =>
          _toDouble(p['totalRevenue']) > m ? _toDouble(p['totalRevenue']) : m,
    );
                          ...
                          return Padding(
                            ...
                            child: Row(
                              children: [
                                ...
                                Text(
                                  _currFmt.format(_toDouble(c['totalSpent'])),
                                  style: TextStyle(
                                    fontSize: 12,
                                    fontWeight: FontWeight.w600,
                                    color: Colors.grey[800],
      ...
      children: [
        Row(
          children: [
            _miniKpi(
              'Total VAT Collected',
              _currFmt.format(totalCollected),
              _warning,
            ),
            const SizedBox(width: 14),
            _miniKpi(
  ...
  Widget _categoryPerformance(List<Map<String, dynamic>> categories) {
    ...
    final maxRev = categories.fold<double>(
      0,
      (m, c) => _toDouble(c['revenue']) > m ? _toDouble(c['revenue']) : m,
    );
